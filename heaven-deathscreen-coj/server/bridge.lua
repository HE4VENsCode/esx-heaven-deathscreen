if Config.Framework == 'esx' then
    ...
    Core.RegisterServerCallback("coj-deathscreen:server:removeMoney", function(source, cb)
...
elseif Config.Framework == 'qbcore' then
    ...
    Core.Functions.CreateCallback("coj-deathscreen:server:removeMoney", function(source, cb)
    ...
    AddEventHandler('hospital:server:SetLaststandStatus', function(isDead)
        TriggerClientEvent('coj-deathscreen:client:onPlayerDeath', source, isDead)
    end)
